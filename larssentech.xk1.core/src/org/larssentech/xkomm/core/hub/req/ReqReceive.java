...
class ReqReceive {
	...
	static int getInboxCountFrom(final User user) {

		return ObjectStoreModel.getMessageCount4(user);
	}

	static synchronized Message getNextFromInboxv(final User u, int type) {

		return ObjectStoreModel.getInboxvNext(u, type);
	}
}
