...
public class BasicGui4Contact extends BasicGui4Account {

	public BasicGui4Contact(AccountPack p, int fieldCols) {

		super(p, fieldCols);
		super.build();

		this.setTitle(Constants4Ui.ADD_CONTACT_TITLE_FULL);
		this.loginLabel.setText(Constants4Ui.DIALOG_INVITE_CONTACT);
